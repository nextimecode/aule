      ...
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-6/12 xl:w-6/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base font-medium leading-relaxed text-body-color">
                  EMAIL: CONTATO@GESTORFLIGHTS.COM TEL: 31 992711521 INSTAGRAM:
                  @brunoizabo CNPJ: 43.784.997/0001-20 CEP 88010-000 RUA FELIPE
                  SCHMIDT 554 CENTRO FLORIANOPOLIS SC
                </p>
            ...
            <div className="w-full px-12 sm:w-1/2 md:w-1/2 lg:w-6/12 xl:w-6/12">
              <div className="mb-12 lg:mb-16">
                <Image
                  src="/images/logo/cadastur.png"
                  alt="cadastur-logo"
                  className="hidden w-full dark:block"
                  width={490}
                  height={110}
        ...
        <div className="bg-primary/10 py-8">
          <div className="container">
            <p className="text-center text-base text-body-color dark:text-white">
              Desenvolvido por{' '}
              <a href="https://www.nextime.com.br/" rel="nofollow noopener">
                NeXTIME
              </a>
            </p>
            <p className="text-center text-base text-body-color dark:text-white">
              Copyright © {new Date().getFullYear()} | GestorFlights | v.
              {version}
            </p>
          </div>
        </div>
